...
public class StageControler {
    ...
    public Stage createStage(
        @RequestParam(value = "titr@@e", defaultValue = "Unknown") String titre,
...
scala.collection.Iterator$$anon$19.next(Iterator.scala:973)
	...
	scala.meta.internal.pc.ScalaPresentationCompiler.references$$anonfun$1(ScalaPresentationCompiler.scala:198)
```
#### Short summary: 
